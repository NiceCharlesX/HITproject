...
public class searchresult extends ActionSupport {
	...
	public String execute(){
		...
		try{
            ...
            while(rs.next())
            {
                if(rs.getString(2).contains(orderby)||rs.getString(4).contains(orderby)||rs.getString(5).contains(orderby)||rs.getString(8).contains(orderby)||rs.getString(9).contains(orderby))
                {
