				...
				<div class="form-group">
					...
					<label for="Name" class="col-md-2">起止时间</label>
					 <div class="input-prepend input-group col-md-10 ">
                       <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span><input type="text" readonly style="width: 205px" name="reservation" class="form-control reservation" value="2014-5-21 - 2014-6-21" /> 
                   </div>
